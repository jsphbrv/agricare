...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('superadmin.varieties.update', $variety->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('superadmin.varieties.index') }}" class="btn btn-secondary">Cancel</a>
    </form>
</div>
@endsection
