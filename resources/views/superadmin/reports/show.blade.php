...
<div class="container mt-4">
    ...
    <div class="mb-4">
        <a href="{{ route('superadmin.reports.pdf', $user->id) }}" class="btn btn-danger" target="_blank">
    ...
    <div class="text-center mt-4">
        <a href="{{ route('superadmin.reports.index') }}" class="btn btn-secondary">Back to List</a>
    </div>
</div>
@endsection
