...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('superadmin.pests.create') }}" class="btn btn-success">+ Add Pest</a>
    </div>

    <!-- Search Bar -->
    <form method="GET" action="{{ route('superadmin.pests.index') }}" class="mb-4">
                ...
                <div class="card">
                   <img 
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ route('superadmin.pests.edit', $pest->id) }}" class="btn btn-sm btn-primary mt-2">Edit</a>
                    </div>
                </div>
            </div>
        @empty
