...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('superadmin.fertilizers.create') }}" class="btn btn-success">+ Add Fertilizer</a>
    </div>

    <form method="GET" action="{{ route('superadmin.fertilizers.index') }}" class="mb-3">
            ...
            <tbody>
                @forelse($fertilizers as $fertilizer)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('superadmin.fertilizers.show', $fertilizer->id) }}" class="btn btn-sm btn-info">Show</a>
                            <a href="{{ route('superadmin.fertilizers.edit', $fertilizer->id) }}" class="btn btn-sm btn-primary">Edit</a>
                        </td>
                    </tr>
                @empty
                    <tr>
