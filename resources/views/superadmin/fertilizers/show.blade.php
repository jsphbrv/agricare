...
<div class="container mt-4">
    <div class="mb-3">
        <a href="{{ route('superadmin.fertilizers.index') }}" class="btn btn-secondary btn-sm">&larr; Back to List</a>
    </div>
        ...
        <div class="row g-0">
            ...
            <div class="col-md-8">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('superadmin.fertilizers.edit', $fertilizer->id) }}" class="btn btn-primary btn-sm me-2">Edit</a>
                        <a href="{{ route('superadmin.fertilizers.index') }}" class="btn btn-secondary btn-sm">Back</a>
                    </div>
                </div>
            </div>
        </div>
