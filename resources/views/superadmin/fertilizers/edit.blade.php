...
<div class="container mt-5" style="max-width: 600px;">
    ...
    {{-- ✅ Edit Form --}}
    <form action="{{ route('superadmin.fertilizers.update', $fertilizer->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="text-center">
            ...
            <a href="{{ route('superadmin.fertilizers.index') }}" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>
