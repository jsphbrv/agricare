                ...
                <tbody>
                    @foreach($riceTypes as $rice)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('superadmin.varieties.show', $rice->id) }}" class="btn btn-info btn-sm">View</a>
                ...
                <tbody>
                    @foreach($cornTypes as $corn)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('superadmin.varieties.show', $corn->id) }}" class="btn btn-info btn-sm">View</a>
