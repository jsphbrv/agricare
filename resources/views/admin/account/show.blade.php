...
<div class="container mt-4">
    <div class="mb-3">
        <a href="{{ route('admin.account.index') }}" class="btn btn-secondary btn-sm">&larr; Back to List</a>
    </div>
    <div class="card shadow border border-2" style="border-radius: 12px;">
        <div class="card-body">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.account.edit', $admin->id) }}" class="btn btn-primary btn-sm me-2">Edit</a>
                <a href="{{ route('admin.account.index') }}" class="btn btn-secondary btn-sm">Back</a>
            </div>
        </div>
    </div>
</div>
