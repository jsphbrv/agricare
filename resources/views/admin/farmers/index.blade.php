...
<div class="container mt-4">
    ...
    <form method="GET" action="{{ route('admin.farmers.index') }}">
        <div class="row g-3 align-items-end mb-3">
            ...
            <div class="col-md-1">
                <a href="{{ route('admin.farmers.index') }}" class="btn btn-secondary w-100">Reset</a>
            </div>

            <div class="col-md-2 text-end">
                <a href="{{ route('admin.farmers.create') }}" class="btn btn-success w-100">+ Add User</a>
            </div>
        ...
        <tbody>
            @forelse ($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.farmers.show', $user->id) }}" class="btn btn-sm btn-primary">View</a>
                        <a href="{{ route('admin.farmers.edit', $user->id) }}" class="btn btn-sm btn-success">Edit</a>
                    </td>
                </tr>
            @empty
                <tr>
