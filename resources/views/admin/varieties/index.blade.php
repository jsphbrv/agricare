...
<div class="container mt-4">
    ...
    <!-- SEARCH + FILTER FORM -->
    <form method="GET" action="{{ route('admin.varieties.index') }}" class="row g-2 mb-4">
        <div class="col-md-4">
        ...
        <div class="col-md-3 text-end">
            <a href="{{ route('admin.varieties.create') }}" class="btn btn-success w-100">Add New Variety</a>
        </div>
    </form>
                ...
                <tbody>
                    @foreach($riceTypes as $rice)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.varieties.show', ['variety' => $rice->id]) }}" class="btn btn-info btn-sm">View</a>
                                <a href="{{ route('admin.varieties.edit', $rice->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
                ...
                <tbody>
                    @foreach($cornTypes as $corn)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.varieties.show', ['variety' => $corn->id]) }}" class="btn btn-info btn-sm">View</a>
                                <a href="{{ route('admin.varieties.edit', $corn->id) }}" class="btn btn-warning btn-sm">Edit</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
