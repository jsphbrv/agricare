...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('admin.pesticides.create') }}" class="btn btn-success">+ Add Pesticide</a>
    </div>

    <!-- Search Bar -->
    <form method="GET" action="{{ route('admin.pesticides.index') }}" class="mb-4">
            ...
            <tbody>
                @forelse($pesticides->where('crop', 'rice') as $pesticide)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.pesticides.edit', $pesticide->id) }}" class="btn btn-sm btn-primary">Edit</a>
                            <a href="{{ route('admin.pesticides.show', $pesticide->id) }}" class="btn btn-sm btn-info">View</a>
                        </td>
                    </tr>
                @empty
                    <tr>
